...
const TourFrom = () => {
  ...
  return (
    ...
    <div className="bg-[#FBFBFB] w-[376px]  px-6 py-4">
            <del><Paragraph text="£2469" className="!text-sm  !text-[#FA3E2C] !font-medium "/></del>
        ...
        <div className="absolute top-[54px] right-16 text-2xl cursor-pointer">
            <Calendar />
        </div>
      </div>
            </div>
            ...
            <div className="relative cursor-pointer">
              ...
              <ul className='text-grayColor'>
                <List to="#" text="Flight" className=" border-b rounded-b-xl border-grayColor block py-2 pl-2 hover:bg-blue-300 hover:text-black hover:rounded-xl"/>
                <List to="#" text="Hotel" className="border-b rounded-b-xl border-grayColor block py-2 pl-2  hover:bg-blue-300 hover:text-black hover:rounded-xl"/>
                <List to="#" text="Car" className="border-b rounded-b-xl border-grayColor block py-2 pl-2  hover:bg-blue-300 hover:text-black hover:rounded-xl"/>
                <List to="#" text="Resort" className="border-b rounded-b-xl border-grayColor block py-2 pl-2 hover:bg-blue-300 hover:text-black hover:rounded-xl"/>
                <List to="#" text="Resturant" className="border-b rounded-b-xl border-grayColor block py-2 pl-2 hover:bg-blue-300 hover:text-black hover:rounded-xl"/>
              </ul>
              </div>
              </div>
            </div>
